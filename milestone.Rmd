...
```{r}
zip_file <- "../yap-tm-master/Coursera-SwiftKey.zip"
pattern <- "en_US.*.txt"
...
[GitHub](https://github.com/musher1720/milestone_project). It will not be reproduced here.
...
load("../yap-tm-master/www/dts_pruned_8.rda")
